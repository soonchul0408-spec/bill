...
.study-grid { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 16px; }.study-card { display: grid; min-height: 250px; padding: 22px; border: 1px solid #e2e8f0; border-radius: 18px; color: inherit; background: #fff; text-align: left; cursor: pointer; transition: transform .16s ease, box-shadow .16s ease, border-color .16s ease; }.study-card:hover { border-color: #60a5fa; box-shadow: 0 14px 25px rgb(30 64 175 / 12%); transform: translateY(-3px); }.study-card__top { display: flex; justify-content: space-between; gap: 8px; align-items: start; }.study-card h3 { margin: 23px 0 8px; color: #172033; font-size: 1.1rem; letter-spacing: -.04em; line-height: 1.35; }.study-card p { margin: 0; color: #64748b; font-size: .86rem; line-height: 1.65; }.study-card footer { display: flex; justify-content: space-between; align-items: center; align-self: end; gap: 10px; margin-top: 18px; padding-top: 14px; border-top: 1px solid #eef2f7; color: #64748b; font-size: .73rem; }.study-card footer strong { color: #2563eb; font-size: .78rem; }
